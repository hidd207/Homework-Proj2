...
經由推導可知，總輸入時間 $t_{input}$ 隨 k 線性成長。這是因為每增加一個 merge 通道，就需更多次磁碟 seek 與 latency 操作，使 I/O 成本提高。而每筆資料的傳輸成本則與資料總量 n 成正比，與 k 無關。因此，t_input 的增長主要由 seek/latency 部分主導。
